...
namespace uTestCollections
    {
    [TestClass]
    public class uTestDoubleLinkedList
        {
        private clsDoubleLinkedList<int> testMyList;
        ...
        public void testDefaultConstructor()
            ...
            #endregion
            #region Test & Assert
            testMyList = new clsDoubleLinkedList<int>();
        ...
        public void testAddNextItemWithHugeCollection()
            ...
            #region Setup
            testMyList = new clsDoubleLinkedList<int>();
            testMyList.opToItems(new int[clsDoubleLinkedList<int>.opGetMaxCapacity() - 1]);
            testExpectedItems = new int[clsDoubleLinkedList<int>.opGetMaxCapacity()];
            testExpectedItems[clsDoubleLinkedList<int>.opGetMaxCapacity() - 1] = 777;
            #endregion
            #region Test & Assert
            Assert.IsTrue(testMyList.opAdd(777));
            Assert.AreEqual(clsDoubleLinkedList<int>.opGetMaxCapacity(), testMyList.opGetLength());
            Assert.IsFalse(testMyList.opItsOrderedAscending());
            Assert.IsFalse(testMyList.opItsOrderedDescending());
            CollectionAssert.AreEqual(testExpectedItems, testMyList.opToArray());
